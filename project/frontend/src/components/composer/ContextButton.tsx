...
export function ContextButton({ className }: { className?: string }) {
  ...
  return (
    <div ref={ref} className={cn('relative', className)}>
      ...
      {/* Popover */}
      {open && (
        <div className="absolute left-0 bottom-full mb-2 w-72 bg-surface-elevated border border-border rounded-xl shadow-2xl z-50 animate-in fade-in slide-in-from-bottom-2 duration-150 overflow-hidden">
          {/* Header */}
